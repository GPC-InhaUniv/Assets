...
{
    class BirthdayParty //비용을 계산하고 장식비를 처리하고 케이크에 들어갈 메시지 글자 수를 확인하는 일을 해야할 것 입니다.
    {
        ...
        {
            decimal TotalCost = CostOfDecorations + (CostOfFoodPerPerson * NumberOfPepple);
            decimal CakeCost;
        ...
        public void CalculateCostOfDecorations(bool fancy)
        {
            ...
            if (fancy)
                CostOfDecorations = (NumberOfPepple * 15.00M) + 50M;
            else
                CostOfDecorations = (NumberOfPepple * 7.50M) + 30M;
        }
    }
}
