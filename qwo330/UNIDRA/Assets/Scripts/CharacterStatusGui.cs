...
public class CharacterStatusGui : MonoBehaviour
{
    ...
    Rect enemyLifeBarRect = new Rect(0f, 0f, 128f, 14f);
    Color enemyFrontLifeBarColor = Color.red;

    // 플레이어 스테이터스 표시
    void DrawPlayerStauts()
    {
    ...
    {
        GUI.Label(new Rect(x, y, nameRect.width, nameRect.height),
            status.characterName, nameLabelStyle);
