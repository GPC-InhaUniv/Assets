...
namespace WindowsFormsApp8
{
    internal class Guy
    {
         ...
         {
             //레이블에 배팅 내역 표시 : 사람이름(Name) + 갖고 있는 돈(Cash)를 이용해 코드를 짜야할 거 같은데 어떻게 짜야할지 모르겠음..
             //라디오 버튼에 붙일 레이블에 현재 현금 보유액 표시 (ex.Joe has 43 bucks) : 라디오 버튼 우측에 있는 레이블에 대한 내용을 짜야할 거 같은데, 각 이름별로 금액을 지급해줘야하나..
         }

         public void ClearBet()
         {
             //내 bet을 리셋함으로서 bet이 zero가 되게 코드를 작성 : 경주가 끝난 후 배팅에 올려놓은 돈을 다시 0으로 만들어주는 코드인가? 잘 모르겠음.
         }
